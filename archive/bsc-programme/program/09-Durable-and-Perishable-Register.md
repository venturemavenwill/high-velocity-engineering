...
Carried from [research/06-microsoft-platform/](/research/06-microsoft-platform/collected-materials.md) and from the [Microsoft AI Platform Map](/archive/bsc-programme/program/11-Microsoft-AI-Platform-Map.md), and binding on every page and every day:
...
**One blind spot remains, and it is declared by the tool in every answer:** [S090](/archive/bsc-programme/seminars/S090.md) has no perishable content of substance. That is a true zero, not a gap — the day's anchor is not a service.
