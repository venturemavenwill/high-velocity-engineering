...
> All 36 courses across 9 quarters. Four courses per quarter at five quarter-units each: 20 units per quarter, 180 across the programme, equivalent to 120 semester credits. Strand codes are defined in [Home](/archive/bsc-programme/Home.md).

**Every course carries a platform anchor** — the named Microsoft AI Platform service it is taught against — and every course paragraph states what the student actually builds on it. The anchors are taken verbatim from the [Microsoft AI Platform Map](/archive/bsc-programme/program/11-Microsoft-AI-Platform-Map.md), which is authoritative where this page and that one differ. A course with no anchor does not exist in this programme.
...
### Q1 · Machines, Programs and Proof — [quarter page](/archive/bsc-programme/quarters/Q1.md)
...
### Q2 · Structure and Scale — [quarter page](/archive/bsc-programme/quarters/Q2.md)
...
### Q3 · Algorithms and Uncertainty — [quarter page](/archive/bsc-programme/quarters/Q3.md)
...
### Q4 · Concurrency and Correctness — [quarter page](/archive/bsc-programme/quarters/Q4.md)
...
### Q5 · Learning Machines — [quarter page](/archive/bsc-programme/quarters/Q5.md)
...
### Q6 · Language and Retrieval — [quarter page](/archive/bsc-programme/quarters/Q6.md)
...
### Q7 · Serving and Economics — [quarter page](/archive/bsc-programme/quarters/Q7.md)
...
### Q8 · Agency and Adversary — [quarter page](/archive/bsc-programme/quarters/Q8.md)
...
### Q9 · Deployment and Entrustment — [quarter page](/archive/bsc-programme/quarters/Q9.md)
...
**On Q9's anchor.** The [Microsoft AI Platform Map](/archive/bsc-programme/program/11-Microsoft-AI-Platform-Map.md) defines course-level anchors for thirty-two of the thirty-six courses and gives Q9 only the quarter-level anchor reproduced above. That is recorded here rather than filled in, because inventing four course anchors for the quarter whose subject is that nothing new is introduced would misrepresent the design. If Q9 later needs course-level anchors, they are added to the map first and copied here second.
...
*The capstone's units are drawn from the strands it integrates; the strand rows above exclude it to avoid double counting. Accreditation-relevant totals are reconciled in [Outcomes and Accreditation Map](/archive/bsc-programme/program/01-Outcomes-and-Accreditation-Map.md).*
