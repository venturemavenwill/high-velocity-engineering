...
|---|---|---|---|---|---|---|
| [M01](/archive/bsc-programme/modules/M01.md) | The Machine and the Proof | Q1 | S001–S005 | 1 | CF MS SY PE | GitHub Copilot agent mode; Learn MCP Server |
| [M02](/archive/bsc-programme/modules/M02.md) | Constructing Correct Programs | Q1 | S006–S010 | 1 | CF MS PE | Custom instructions as executable specification; Copilot as a proof-checking adversary |
| [M03](/archive/bsc-programme/modules/M03.md) | Representing Structure | Q2 | S011–S015 | 1 | CF MS SY | Foundry embedding models; Copilot-generated implementations against a cost model stated first |
| [M04](/archive/bsc-programme/modules/M04.md) | Managing Memory, Time and Contention | Q2 | S016–S020 | 2 | SY CF MS PE | Azure MCP Server (read); Azure compute and memory limits as the instance of contention |
| [M05](/archive/bsc-programme/modules/M05.md) | Algorithmic Thinking Under Constraint | Q3 | S021–S025 | 2 | CF MS SY | Copilot's frontier, located empirically; Azure AI Search index schema |
| [M06](/archive/bsc-programme/modules/M06.md) | Evidence, Error and Measurement | Q3 | S026–S030 | 2 | ME MS SY PE | Foundry evaluators; Foundry evaluation score distributions |
| [M07](/archive/bsc-programme/modules/M07.md) | Correctness at Scale | Q4 | S031–S035 | 3 | SY CF MS | API Management load balancing, circuit breaking, partial failure; MCP tool definitions as an interface contract |
| [M08](/archive/bsc-programme/modules/M08.md) | Understanding the Problem Before the Solution | Q4 | S036–S040 | 3 | PE CF SY | Substrate stakeholder work; quota negotiation as a real constraint |
| [M09](/archive/bsc-programme/modules/M09.md) | Learning From Data | Q5 | S041–S045 | 3 | IS MS ME SG | Foundry model catalogue, deployment and the fine-tuning path; Defender AI posture |
| [M10](/archive/bsc-programme/modules/M10.md) | Evaluating What Was Learned | Q5 | S046–S050 | 4 | ME IS MS SG | Foundry cloud evaluation; the conversation split decision |
| [M11](/archive/bsc-programme/modules/M11.md) | Language, Attention and Representation | Q6 | S051–S055 | 4 | IS MS ME | Foundry model catalogue across families; deployment as an architectural choice |
| [M12](/archive/bsc-programme/modules/M12.md) | Finding the Right Thing | Q6 | S056–S060 | 4 | IS ME SY PE | Azure AI Search vector and hybrid retrieval; semantic ranking; the chunking trap |
| [M13](/archive/bsc-programme/modules/M13.md) | The Economics of Inference | Q7 | S061–S065 | 5 | IS SY ME | Provisioned throughput; **quota is not capacity**; spillover; hourly billing |
| [M14](/archive/bsc-programme/modules/M14.md) | Releasing Responsibly | Q7 | S066–S070 | 5 | ME SY SG PE | Foundry cloud evaluation in CI; AI Search document-level ACLs; Purview DSPM for AI |
| [M15](/archive/bsc-programme/modules/M15.md) | Agents That Act | Q8 | S071–S075 | 5 | IS SG ME SY | Microsoft Agent Framework; Foundry Agent Service; MCP |
| [M16](/archive/bsc-programme/modules/M16.md) | The Adversary and the Accident | Q8 | S076–S080 | 6 | SG ME PE IS | Prompt injection against a real agent; Foundry observability and tracing; Defender AI alerts |
| [M17](/archive/bsc-programme/modules/M17.md) | Deployment as Engagement | Q9 | S081–S085 | 6 | PE all | The whole stack, handed over |
| [M18](/archive/bsc-programme/modules/M18.md) | Entrustment and Handover | Q9 | S086–S090 | 6 | all | The whole stack, handed over |

### How the module anchors were derived

The [Microsoft AI Platform Map](/archive/bsc-programme/program/11-Microsoft-AI-Platform-Map.md) assigns anchors to courses and to quarters, not to modules, because modules are not credit-bearing and the map is written for the reader who is auditing the curriculum. **A module's anchor is therefore the subset of its quarter's course anchors belonging to the courses that module actually recruits.** Nothing above is invented, and where this page and the map disagree the map is correct.
...
**M14's anchor is short by one strand, and the reason is a known defect.** M14 recruits PE and Q7 has no PE course, so the derivation has nothing to draw from and the module's professional-formation content has no platform anchor. This is the same misalignment recorded against [WP-069](/archive/bsc-programme/whitepapers/WP-069.md) §8 in the [Whitepaper Standard](/archive/bsc-programme/program/05-Whitepaper-Standard.md)'s compliance register, where it stands as **Recorded** on the ground that repairing it requires a Course Catalogue change. The platform anchors did not create the defect and do not repair it; they make it visible in a second place, which is the only thing being claimed here.
