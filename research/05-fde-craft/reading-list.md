...
- Kotter, J. P. *Leading Change.* Harvard Business Review Press, 1996; anniversary edition 2012. Precursor article: Kotter, J. P. "Leading Change: Why Transformation Efforts Fail", *Harvard Business Review*, 1995. **Copyrighted — synthesis only.**
- Hiatt, J. M. *ADKAR: A Model for Change in Business, Government and our Community.* Prosci Learning Center Publications, 2006. **Copyrighted — synthesis only.** Prosci publishes open descriptions of the five elements and the barrier-point concept.

## The composite role in practice
- Microsoft Industry Solutions Engineering. *Engineering Fundamentals Playbook.* https://microsoft.github.io/code-with-engineering-playbook/ — **open access**, GitHub repository microsoft/code-with-engineering-playbook, contributable by pull request. Start with the Engineering Fundamentals Checklist and The First Week of an ISE Project.
...
- Palantir Blog. "Dev versus Delta: Demystifying Engineering Roles at Palantir" — retrieval blocked by a sign-in redirect. The Dev versus Delta distinction is available from the day-in-the-life interview instead.
