...
- The barrier point, the first weak element, determines which intervention to address first. **Amended 2026-07-30: this line previously continued "; effort spent past it is wasted", and [hiatt-adkar.md](/research/05-fde-craft/hiatt-adkar.md) records that the book does not say that.** The sequencing claim is the book's; the waste claim was this folder's own inference, stated in the source's voice, and it is withdrawn. What the book does state absolutely is narrower and survives: without awareness, no amount of knowledge produces change.
...
- **The entry point is the set of about ten artefact templates, which the site indexes nowhere.** *Amended 2026-07-30 on a reading of all 243 pages; this line previously read "Entry points that give it teeth: the Engineering Fundamentals Checklist and The First Week of an ISE Project."* The checklist is a good inventory and a partial instrument — its items are not uniformly falsifiable as written — and the First Week page is a navigation index rather than a guide. The templates are complete specifications.
- The design review apparatus of decision logs, architecture decision records, trade studies with a template and engineering feasibility spikes is the strand's best model for assessing engineering judgement in writing, and the async review workflow with its two-round-trip escalation rule is how all of it is meant to be reviewed.
- The ML and AI Projects section supplies an ML Fundamentals Checklist, an ML Model Production Checklist and Responsible AI guidance placed inside the engineering process. **The production checklist declines gate semantics in its own words**, so it may structure a decision and may not be a pass condition.
- Non-functional requirements run to seventeen pages rather than the fifteen named categories, **and only nine follow the section's own structure**; observability is organised as dashboards, logging, metrics and tracing.
- **Engineering Feedback is a writing standard for a single report, not an institutional loop.** *Amended 2026-07-30; this line previously read "and is the institutional mechanism turning field friction into product input."* The four-page section specifies the fields of a report and describes **no routing, triage, ownership, service level or closure** — so the mechanism this folder credited it with is not in it.
- **About half the site is substantive practice; roughly a quarter is recipe bound to a named tool at a named version and roughly a fifth is stub, link list or one team's example instance — and nothing in the navigation distinguishes them.** Its page footer dates span four years, so it cannot be dated as a whole and every citation must name a page and that page's date.

### Palantir FDE practitioner writing (open access, blog.palantir.com and palantir.com/careers)
- Grounded in two retrieved primary sources. "Dev versus Delta: Demystifying engineering roles at Palantir", Palantir Blog, 8 April 2019, was read in full on 2026-07-30 from a locally held plain-text copy at `raw/palantir-dev-vs-delta.txt`, having been blocked by a sign-in redirect in the earlier pass. It is the company's own definitional statement of the two roles and is now the primary text for the distinction.
