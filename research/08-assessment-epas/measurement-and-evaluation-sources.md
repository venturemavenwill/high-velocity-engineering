...
- **Huyen, *AI Engineering*** — **not consulted when this note was written.** The book has since been read, on 2026-07-30, with both evaluation chapters read in full. **Nothing in this note rests on it**, and the note has not been rewritten against it.
